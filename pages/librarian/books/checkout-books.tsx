...
const BooksListPage = () => {
  ...
  const { booksRequestedByStudents } = useBooks({ title, author, genre });
  if (!booksRequestedByStudents) return null;
  ...
  return (
    <UserLayout>
      ...
      <Typography variant="body1" gutterBottom sx={{ mb: 3 }}>
        Here is the list of books that have been requested by students along the
        platform
      </Typography>
      ...
      <Table sx={{ my: 2 }}>
        ...
        <TableBody>
          {booksRequestedByStudents?.qBooksRequestedByStudents?.map((book) => (
            <TableRow key={book?._id}>
              ...
              <TableCell align="right">
                <Anchor href={`${routes.librarianBooks}/${book?._id}`}>
